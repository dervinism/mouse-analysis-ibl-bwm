...
elseif strcmpi(areaOI, 'RSP')
  areaInds = ismember(areaTable.Brain_area_acronym, 'RSPagl') | ...
    ...
    ismember(areaTable.Brain_area_acronym, 'RSPv');
elseif strcmpi(areaOI, 'VIS')
  areaInds = ismember(areaTable.Brain_area_acronym, 'VISa') | ...
    ismember(areaTable.Brain_area_acronym, 'VISam') | ...
    ismember(areaTable.Brain_area_acronym, 'VISl') | ...
    ismember(areaTable.Brain_area_acronym, 'VISli') | ...
    ismember(areaTable.Brain_area_acronym, 'VISp') | ...
    ismember(areaTable.Brain_area_acronym, 'VISpl') | ...
    ismember(areaTable.Brain_area_acronym, 'VISpm') | ...
    ismember(areaTable.Brain_area_acronym, 'VISpor') | ...
    ismember(areaTable.Brain_area_acronym, 'VISrl');
...
elseif ismember(areaOI, {'AA'; 'BG'; 'Hyp'; 'MBr'; 'Cereb'; 'CLA'; 'BS'; ...
    'BG'; 'EPT'; 'BF'; 'STh'})
  pause(1)
else
