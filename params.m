...
% IO
processedDataFolder = 'C:\Users\44079\Work\Leicester\infraslow-dynamics\04_data_analysis\005_ibl_bwm';
figFolder = 'C:\Users\44079\Work\Leicester\infraslow-dynamics\05_figures\005_ibl_bwm';
...
areaLabels = { ...
  'AA',     'AAA',      'Anterior amygdalar area';
  'nCx',    'ACAd',  	  'Anterior cingulate area, dorsal part';
  'nCx',    'ACAv',     'Anterior cingulate area, ventral part';
  'BG',     'ACB',      'Nucleus accumbens';
  'Th',     'AD',       'Anterodorsal nucleus';
  'Hyp',    'AHN',      'Anterior hypothalamic nucleus';
  'nCx',    'AId',      'Agranular insular area, dorsal part';
  'nCx',    'AIp',      'Agranular insular area, posterior part';
  'nCx',    'AIv',      'Agranular insular area, ventral part';
  'Th',     'AM',       'Anteromedial nucleus';
  'MBr',    'ANcr1',    'Crus 1';
  'MBr',    'ANcr2',    'Crus 2';
  'pCx',    'AON',      'Anterior olfactory nucleus';
  'MBr',    'APN',      'Anterior pretectal nucleus';
  'nCx',    'APr',      'Area prostriata';
  'MBr',    'AT',       'Anterior tegmental nucleus';
  'nCx',    'AUDd',     'Dorsal auditory area';
  'nCx',    'AUDp',     'Primary auditory area';
  'nCx',    'AUDpo',    'Posterior auditory area';
  'nCx',    'AUDv',     'Ventral auditory area';
  'Th',     'AV',       'Anteroventral nucleus of thalamus';
  ...
  'Th',     'CL',       'Central lateral nucleus of the thalamus';
  'CLA',    'CLA',      'Claustrum';
  'BS',     'CLI',      'Central linear nucleus raphe';
  'Th',     'CM',       'Central medial nucleus of the thalamus';
  ...
  'nCx',    'DP',       'Dorsal peduncular area';
  'BS',     'DR',       'Dorsal nucleus raphe';
  'BS',     'DT',       'Dorsal terminal nucleus of the accessory optic tract';
  'BS',     'DTN',      'Dorsal tegmental nucleus';
  'paCx',   'ECT',      'Ectorhinal area';
  'BS',     'ECU',      'External cuneate nucleus';
  'paCx',   'ENTl',     'Entorhinal area, lateral part';
  'paCx',   'ENTm',     'Entorhinal area, medial part, dorsal zone';
  'pCx',    'EPd',      'Endopiriform nucleus, dorsal part';
  'pCx',    'EPv',      'Endopiriform nucleus, ventral part';
  'Th',     'Eth',      'Ethmoid nucleus of the thalamus';
  'Hp',     'FC',       'Fasciola cinerea';
  'Cereb',  'FL',  	    'Flocculus';
  'Cereb',  'FN',       'Fastigial nucleus';
  'nCx',    'FRP',      'Frontal pole, cerebral cortex';
  'BG',     'FS',       'Fundus of striatum';
  'BG',     'GPe',      'Globus pallidus, external segment';
  'BS',     'GRN',      'Gigantocellular reticular nucleus';
  'nCx',    'GU',       'Gustatory areas';
  'AA',     'HATA',  	  'Hippocampo-amygdalar transition area';
  'Th',     'IAD',      'Interanterodorsal nucleus of the thalamus';
  'Th',     'IAM',      'Interanteromedial nucleus of the thalamus';
  'MBr',    'IC',       'Inferior colliculus';
  'Cereb',  'ICB',      'Infracerebellar nucleus';
  'Th',     'IGL',      'Intergeniculate leaflet of the lateral geniculate complex';
  'nCx',    'ILA',      'Infralimbic area';
  'Th',     'IMD',      'Intermediodorsal nucleus of the thalamus';
  'Th',     'IP',       'Interposed nucleus';
  'Cereb',  'IPN',      'Interpeduncular nucleus';
  'BS',     'IRN',      'Intermediate reticular nucleus';
  'BS',     'ISN',      'Inferior salivatory nucleus';
  'Th',     'IntG',     'Intermediate geniculate nucleus';
  'AA',     'LA',       'Lateral amygdalar nucleus';
  'BS',     'LAV',      'Lateral vestibular nucleus';
  'BS',     'LC',       'Locus ceruleus';
  'Th',     'LD',       'Lateral dorsal nucleus of thalamus';
  'BS',     'LDT',      'Laterodorsal tegmental nucleus';
  'Th',     'LGd',      'Dorsal part of the lateral geniculate complex';
  'Th',     'LGv',      'Ventral part of the lateral geniculate complex';
  'EPT',    'LH',       'Lateral habenula';
  'Hyp',    'LHA',      'Lateral hypothalamic area';
  'nCx',    'LING',     'Lingula (I)';
  'Th',     'LP',  	    'Lateral posterior nucleus of the thalamus';
  ...
  'Th',     'MD', 	    'Mediodorsal nucleus of thalamus';
  'BS',     'MDRN',     'Medullary reticular nucleus';
  'AA',     'MEA',      'Medial amygdalar nucleus';
  'Th',     'MG',       'Medial geniculate complex';
  'EPT',    'MH',       'Medial habenula';
  'Hyp',    'MM',       'Medial mammillary nucleus';
  'nCx',    'MOp',      'Primary motor area';
  'nCx',    'MOs',      'Secondary motor area';
  ...
  'nCx',    'ORBm',     'Orbital area, medial part';
  'nCx',    'ORBvl',    'Orbital area, ventrolateral part';
  'BG',     'OT',       'Olfactory tubercle';
  'BS',     'P5',       'Peritrigeminal zone';
  'AA',     'PA',       'Posterior amygdalar nucleus';
  'MBr',    'PAG',      'Periaqueductal gray';
  'paCx',   'PAR',      'Parasubiculum';
  ...
  'Th',     'PCN',      'Paracentral nucleus';
  'BS',     'PDTg',     'Posterodorsal tegmental nucleus';
  'paCx',   'PERI',     'Perirhinal area';
  'Th',     'PF',       'Parafascicular nucleus';
  'Cereb',  'PFL',      'Paraflocculus';
  'BS',     'PG',       'Pontine gray';
  'BS',     'PGRN',     'Paragigantocellular reticular nucleus';
  'Hyp',    'PH',       'Posterior hypothalamic nucleus';
  'Th',     'PIL',      'Posterior intralaminar thalamic nucleus';
  'pCx',    'PIR',      'Piriform area';
  'nCx',    'PL',       'Prelimbic area';
  'Hyp',    'PMd',      'Dorsal premammillary nucleus';
  'Th',     'PO',  	    'Posterior complex of the thalamus';
  'Th',     'POL',      'Posterior limiting nucleus of the thalamus';
  'paCx',   'POST',  	  'Postsubiculum';
  'BS',     'PP',       'Peripeduncular nucleus';
  'BS',     'PPN',      'Pedunculopontine nucleus';
  'MBr',    'PPT',      'Posterior pretectal nucleus';
  'Th',     'PR',       'Perireunensis nucleus';
  'paCx',   'PRE',      'Presubiculum';
  ...
  'nCx',    'SSp-bfd',  'Primary somatosensory area, barrel field';
  'nCx',    'SSp-ll',   'Primary somatosensory area, lower limb';
  'nCx',    'SSp-m',    'Primary somatosensory area, mouth';
  'nCx',    'SSp-n',    'Primary somatosensory area, nose';
  'nCx',    'SSp-tr',   'Primary somatosensory area, trunk';
  'nCx',    'SSp-ul',   'Primary somatosensory area, upper limb';
  'nCx',    'SSp-un',   'Primary somatosensory area, unassigned';
  'nCx',    'SSs',      'Supplemental somatosensory area';
  ...
  'Th',     'SubG',     'Subgeniculate nucleus';
  'nCx',    'TEa',      'Temporal association areas';
  'BS',     'TRN',      'Tegmental reticular nucleus';
  'BF',     'TRS',      'Triangular nucleus of septum';
  'pCx',    'TTd',      'Taenia tecta, dorsal part';
  'pCx',    'TTv',      'Taenia tecta, ventral part';
  'Hyp',    'TU',       'Tuberal nucleus';
  'Cereb',  'UVU',      'Uvula (IX)';
  'BS',     'V',        'Motor nucleus of trigeminal';
  'Th',     'VAL',      'Ventral anterior-lateral complex of the thalamus';
  'BS',     'VCO',      'Ventral cochlear nucleus';
  'BS',     'VII',      'Facial motor nucleus';
  'nCx',    'VISC',     'Visceral area';
  'nCx',    'VISa',     'Anterior area';
  'nCx',    'VISam',    'Anteromedial visual area';
  'nCx',    'VISl',     'Lateral visual area';
  'nCx',    'VISli',    'Laterointermediate area';
  'nCx',    'VISp',     'Primary visual area';
  'nCx',    'VISpl',    'Posterolateral visual area';
  'nCx',    'VISpm',    'posteromedial visual area';
  'paCx',   'VISpor',   'Postrhinal area';
  'nCx',    'VISrl',    'Rostrolateral visual area';
  'Th',     'VM',       'Ventral medial nucleus of the thalamus';
  'Hyp',    'VMH',      'Ventromedial hypothalamic nucleus';
  'Th',     'VPL',      'Ventral posterolateral nucleus of the thalamus';
  'Th',     'VPLpc',    'Ventral posterolateral nucleus of the thalamus, parvicellular part';
  'Th',     'VPM',      'Ventral posteromedial nucleus of the thalamus';
  'Th',     'VPMpc',    'Ventral posteromedial nucleus of the thalamus, parvicellular part';
  'MBr',    'VTA',      'Ventral tegmental area';
  'MBr',    'VTN',      'Ventral tegmental nucleus';
  'Cereb',  'VeCB',     'Vestibulocerebellar nucleus';
  'Th',     'Xi',       'Xiphoid thalamic nucleus';
  'STh',    'ZI',       'Zona incerta';
  '???',    'root',     'root';
  '???',    'void',     'void';
  'BS',     'x',        'Nucleus x'};